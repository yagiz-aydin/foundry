import { FoundryLocalManager as FoundryLocalManager$1, Fetch, DeviceType, FoundryModelInfo } from './base.mjs';
export { DownloadBody, ExecutionProvider, FoundryListResponseModel, ModelRuntime } from './base.mjs';

/**
 * Class representing the Foundry Local Manager.
 */
declare class FoundryLocalManager extends FoundryLocalManager$1 {
    /**
     ...
     */
    constructor({ fetch: overriddenFetch }?: {
        fetch?: Fetch;
    });
    /**
     ...
     */
    init(aliasOrModelId: string | null, device?: DeviceType): Promise<FoundryModelInfo | null>;
    /**
...
export { DeviceType, Fetch, FoundryLocalManager, FoundryModelInfo };
